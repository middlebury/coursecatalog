 ...
 * @package org.osid
 */
abstract class phpkit_AbstractOsidSession
	implements osid_OsidSession
{
    ...
    public function getAuthenticatedAgents() {
    	...
    	return new phpkit_authentication_ArrayAgentList(array());
    }
    ...
    public function startTransaction() {
    	...
    	throw new osid_UnsupportedException('Transactions not supported');
    }
