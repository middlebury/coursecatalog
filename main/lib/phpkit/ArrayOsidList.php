...
class phpkit_ArrayOsidList
{
	 ...
	 * Constructor.
	 * 
	 * @param array $elements An array of elements to iterate over.
	 * @return void
	 * @access public
	 * @since 10/29/08
	 */
    ...
    public function hasNext() {
    	return ($this->i < count($this->elements) - 1);
    }

	/**
     *  Gets the next element in this list. 
     *
     *  @return mixed the next elemet
     *          in this list. The <code> hasNext() </code> method should be 
     *          used to test that a next element is 
	...
	protected function next () {
		if (!$this->hasNext())
			throw new osid_IllegalStateException("no more elements available in this list");
	...
	/**
     *  Gets the next set of elements in this list 
     ...
     *          available() </code> 
     *  @return array of objects  an array of elements. The length of the 
    ...
    public function available() {
    	if ($i < 0)
	    	...
	    	return count($this->elements) - ($this->i + 1);
    }
