...
/**
 * osid_resource_ResourceProxyManager
 * 
 *     Specifies the OSID definition for osid_resource_ResourceProxyManager.
 * 
 ...
 * @package org.osid.resource
 */
interface osid_resource_ResourceProxyManager
            ...
            osid_resource_ResourceProfile
{
     ...
     */
    public function getResourceLookupSession(osid_authentication_Authentication $authentication);
     ...
     */
    public function getResourceSearchSession(osid_authentication_Authentication $authentication);
     ...
     */
    public function getResourceAdminSession(osid_authentication_Authentication $authentication);
     ...
     *
     *  @param object osid_resource_ResourceReceiver $receiver notification 
     *          callback 
     *  @param object osid_authentication_Authentication $authentication proxy 
     *          authentication 
     ...
     *  @param object osid_resource_ResourceReceiver $receiver notification 
     *          callback 
     *  @param object osid_id_Id $bin the <code> Id </code> of the bin 
     *  @param object osid_authentication_Authentication $authentication proxy 
     *          authentication 
     *  @return object osid_resource_ResourceNotificationSession <code> a 
     *          ResourceNotificationSession </code> 
     *  @throws osid_NotFoundException <code> binId </code> not found 
     *  @throws osid_NullArgumentException <code> receiver, binId </code> or 
     ...
     */
    public function getResourceBinSession(osid_authentication_Authentication $authentication);
     ...
     *              </code> 
     */
    public function getResourceBinAssignmentSession(osid_authentication_Authentication $authentication);
     ...
     */
    public function getBinLookupSession(osid_authentication_Authentication $authentication);
     ...
     */
    public function getBinSearchSession(osid_authentication_Authentication $authentication);
     ...
     */
    public function getBinAdminSession(osid_authentication_Authentication $authentication);


    /**
     *  Gets the notification session for subscribing to changes to a bin. 
     *
     *  @param object osid_resource_BinReceiver $receiver notification 
     *          callback 
     *  @param object osid_authentication_Authentication $authentication proxy 
     *          authentication 
     ...
     */
    public function getBinHierarchySession(osid_authentication_Authentication $authentication);
     ...
     *              </code> 
     */
    public function getBinHierarchyDesignSession(osid_authentication_Authentication $authentication);
