...
/**
 * osid_resource_BinForm
 * 
 *     Specifies the OSID definition for osid_resource_BinForm.
 * 
...
/**
 *  <p>This is the form for creating and updating bins. <code> </code> Like 
 *  all <code> OsidForm </code> objects, various data elements may be set here 
 *  for use in the create and update methods in the <code> BinAdminSession. 
 *  </code> For each data element that may be set, metadata may be examined to 
 *  provide display hints or data constraints. </p>
 * 
 * @package org.osid.resource
 */
interface osid_resource_BinForm
    extends osid_OsidCatalogForm
{


    /**
     *  Gets the <code> BinFormRecord </code> interface corresponding to the 
     *  given bin record interface <code> Type. </code> 
     *
     *  @param object osid_type_Type $binRecordType the bin record type 
     *  @return object osid_resource_BinFormRecord the record 
     ...
     */
    public function getBinFormRecord(osid_type_Type $binRecordType);
