 ...
 * osid_id_IdList
 * 
 *     Specifies the OSID definition for osid_id_IdList.
 * 
...
/**
 *  <p>Like all <code> OsidLists, </code> Id <code> List </code> provides a 
 *  means for accessing <code> Id </code> elements sequentially either one at 
    ...
    extends osid_OsidList
{
     ...
     *  available(). </code> 
     *
     *  @param integer $n the number of <code> Id </code> elements requested 
