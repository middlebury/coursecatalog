...
/**
 * osid_dictionary_EntrySearch
 * 
 *     Specifies the OSID definition for osid_dictionary_EntrySearch.
 * 
...
/**
 *  <p>This interface specifies options for governing entry searches. </p>
 * 
 * @package org.osid.dictionary
 */
interface osid_dictionary_EntrySearch
{
    ...
    /**
     *  Eexecute this search using a previous search result. 
     *
     *  @param object osid_dictionary_EntrySearchResults $results results from 
     *          a query 
     ...
     *  @compliance mandatory This method must be implemented. 
     */
    public function searchWithinEntryResults(osid_dictionary_EntrySearchResults $results);


    /**
     *  Execute this search among the given list of entries. 
     *
     *  @param object osid_dictionary_EntryList $entries list of entries 
     *  @throws osid_NullArgumentException <code> entries </code> is <code> 
     *          null </code> 
     *  @compliance mandatory This method must be implemented. 
     */
    public function searchAmongEntries(osid_dictionary_EntryList $entries);


    /**
     *  Specify an ordering to the search results. 
     *
     *  @param object osid_dictionary_EntrySearchOrder $entrySearchOrder entry 
     *          searcgh order 
     *  @throws osid_NullArgumentException <code> entrySearchOrder </code> is 
     *          <code> null </code> 
     *  @throws osid_UnsupportedException <code> entrySearchOrder </code> is 
     *          not of this service 
     *  @compliance mandatory This method must be implemented. 
     */
    public function orderEntryResults(osid_dictionary_EntrySearchOrder $entrySearchOrder);


    /**
     *  Gets the record corresponding to the given entry search record <code> 
     ...
     *  ancestor interfaces. 
     *
     *  @param object osid_type_Type $entrySearchRecordType an entry search 
     *          record type 
     *  @return object osid_dictionary_EntrySearch the entry search interface 
     *  @throws osid_NullArgumentException <code> entrySearchRecordType 
     *          </code> is <code> null </code> 
     *  @throws osid_OperationFailedException unable to complete request 
     *  @throws osid_PermissionDeniedException authorization failure occurred 
     *  @throws osid_UnsupportedException <code> 
     *          hasSearchRecordType(entrySearchRecordType) </code> is <code> 
     *          false </code> 
     *  @compliance mandatory This method must be implemented. 
     */
    public function getEntrySearchRecord(osid_type_Type $entrySearchRecordType);
