...
/**
 * osid_dictionary_Entry
 * 
 *     Specifies the OSID definition for osid_dictionary_Entry.
 * 
...
/**
 *  <p>An <code> Entry </code> contains a key and a value. The key and value 
 ...
 *  translation from one arbitrary object to another. </p>
 * 
 * @package org.osid.dictionary
 */
interface osid_dictionary_Entry
{
     ...
     *
     *  @return object osid_type_Type the key <code> Type </code> 
     ...
     *
     *  @return object osid_type_Type the value <code> Type </code> 
     *  @compliance mandatory This method must be implemented. 
     */
