 ...
 * 
 *     Specifies the OSID definition for osid_type_TypeProfile.
 * 
...
/**
 *  <p>The <code> TypeProfile </code> describes the interoperability among 
 *  type services. </p>
 * 
 * @package org.osid.type
 */
interface osid_type_TypeProfile
    extends osid_OsidProfile
{
     ...
     *
     *  @return boolean <code> true </code> if <code> Type </code> lookup is 
     *          supported, <code> false </code> otherwise 
     *  @compliance mandatory This method must be implemented. 
     */
    public function supportsTypeLookup();


    /**
     *  Tests if a <code> Type </code> administrative service is supported. 
     *
     *  @return boolean <code> true </code> if <code> Type </code> 
     *          administration is supported, <code> false </code> otherwise 
     *  @compliance mandatory This method must be implemented. 
     */
    public function supportsTypeAdmin();
