...
/**
 * osid_type_TypeManager
 * 
 *     Specifies the OSID definition for osid_type_TypeManager.
 * 
 ...
 *  service. The <code> TypeLookupSession </code> is used for looking up 
 *  <code> Types </code> and the <code> TypeAdminSession </code> is used for 
 *  managing and registering new Types. </p>
 * 
 * @package org.osid.type
 */
interface osid_type_TypeManager
            ...
            osid_type_TypeProfile
{
     ...
     */
    public function getTypeLookupSession();
     ...
     *  service. 
     *
     *  @return object osid_type_TypeAdminSession a <code> TypeAdminSession 
     *          </code> 
     *  @throws osid_OperationFailedException unable to complete request 
     ...
     */
    public function getTypeAdminSession();
