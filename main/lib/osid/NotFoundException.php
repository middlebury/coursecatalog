...
/**
 * osid_NotFoundException
 * 
 *     Specifies the OSID exception osid_NotFoundException.
 * 
...
class osid_NotFoundException
    extends osid_OsidException
{


    /**
     *  Constructs a <code>osid_NotFoundException</code> with the specified
