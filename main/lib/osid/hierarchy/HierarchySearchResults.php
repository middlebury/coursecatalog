...
/**
 * osid_hierarchy_HierarchySearchResults
 * 
 *     Specifies the OSID definition for osid_hierarchy_HierarchySearchResults.
 * 
 ...
 * @package org.osid.hierarchy
 */
interface osid_hierarchy_HierarchySearchResults
    extends osid_OsidSearchResults
{
     ...
     *
     *  @return object osid_hierarchy_HierarchyList the hierarchy list 
     ...
     *          search record type 
     *  @return object osid_hierarchy_HierarchySearchResultsRecord the 
     *          hierarchy search interface 
     *  @throws osid_NullArgumentException <code> hierarchySearchRecordType 
     *          </code> is <code> null </code> 
     *  @throws osid_OperationFailedException unable to complete request 
     *  @throws osid_PermissionDeniedException authorization failure occurred 
     *  @throws osid_UnsupportedException <code> 
     *          hasSearchRecordType(hierarchySearchRecordType) </code> is 
     *          <code> false </code> 
     *  @compliance mandatory This method must be implemented. 
     */
    public function getHierarchySearchResultsRecord(osid_type_Type $hierarchySearchRecordType);
