...
/**
 * osid_filing_FilingManager
 * 
 *     Specifies the OSID definition for osid_filing_FilingManager.
 * 
 ...
 *  directories can be accessed by a specified path. The sessions included in 
 *  this manager are: 
 *  <ul>
 ...
 * @package org.osid.filing
 */
interface osid_filing_FilingManager
            ...
            osid_filing_FilingProfile
{
     ...
     *  @throws osid_NullArgumentException <code> filePath </code> is null 
     *  @throws osid_OperationFailedException unable to complete request 
     *  @throws osid_UnimplementedException <code> supportsFiles() </code> is 
     *          <code> false </code> 
     *  @throws osid_IllegalStateException this manager has been shut down 
     ...
     */
    public function getFileSearchSession();
     ...
     *          found 
     *  @throws osid_NullArgumentException <code> directoryPath </code> is 
     *          null 
     *  @throws osid_OperationFailedException unable to complete request 
     *  @throws osid_UnimplementedException <code> supportsFileSearch() 
     *          </code> is <code> false </code> 
     ...
     *  @throws osid_NullArgumentException <code> receiver </code> is null 
     *  @throws osid_OperationFailedException unable to complete request 
     ...
     *              </code> 
     */
    public function getDirectoryEntryLookupSession();
     ...
     */
    public function getDirectorySearchSession();
     ...
     */
    public function getDirectoryAdminSession();
     ...
     */
    public function getFilingManagementSession();
     ...
     */
    public function getAllocationSession();
     ...
     */
    public function getAllocationAdminSession();
