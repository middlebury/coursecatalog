...
/**
 * osid_filing_DirectorySearch
 * 
 *     Specifies the OSID definition for osid_filing_DirectorySearch.
 * 
...
/**
 *  <p>The search interface for gioverning directory searches. An example to 
 *  find directories whose name is "Library" sorted by the path name. </p> 
 *  
 *  <p> 
 *  <pre>
 *       
 ...
 * @package org.osid.filing
 */
interface osid_filing_DirectorySearch
    extends osid_OsidSearch
{
     ...
     *
     *  @param object osid_filing_DirectorySearchResults $results results from 
     *          a query 
     ...
     */
    public function searchWithinDirectoryResults(osid_filing_DirectorySearchResults $results);
     ...
     *  @throws osid_NullArgumentException <code> directories </code> is 
     *          <code> null </code> 
     *  @compliance mandatory This method must be implemented. 
     */
    public function searchAmongDirectories(array $directories);


    /**
     *  Specify an ordering to the search results. 
     *
     *  @param object osid_filing_DirectorySearchOrder $directorySearchOrder 
     *          directory search order 
     *  @throws osid_NullArgumentException <code> directorySearchOrder </code> 
     *          is <code> null </code> 
     *  @throws osid_UnsupportedException <code> directorySearchOrder </code> 
     *          is not of this service 
     *  @compliance mandatory This method must be implemented. 
     */
    public function orderDirectoryResults(osid_filing_DirectorySearchOrder $directorySearchOrder);
     ...
     *          search record type 
     *  @return object osid_filing_DirectorySearchRecord the directory search 
     *          interface 
     ...
     *  @compliance mandatory This method must be implemented. 
     */
    public function getDirectorySearchRecord(osid_type_Type $directorySearchRecordType);
