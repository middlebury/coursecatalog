...
/**
 * osid_IllegalStateException
 * 
 *     Specifies the OSID exception osid_IllegalStateException.
 * 
...
class osid_IllegalStateException
    extends osid_OsidRuntimeException
{


    /**
     *  Constructs a <code>osid_IllegalStateException</code> with the specified
