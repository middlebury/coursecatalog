...
/**
 * osid_cataloging_CatalogSearchResults
 * 
 *     Specifies the OSID definition for osid_cataloging_CatalogSearchResults.
 * 
 ...
 * @package org.osid.cataloging
 */
interface osid_cataloging_CatalogSearchResults
    extends osid_OsidSearchResults
{
     ...
     *
     *  @return object osid_cataloging_CatalogList the catalogs list 
     ...
     *          record type 
     *  @return object osid_cataloging_CatalogSearchResultsRecord the catalog 
     *          search interface 
     ...
     *  @compliance mandatory This method must be implemented. 
     */
    public function getCatalogSearchResultsRecord(osid_type_Type $catalogSearchRecordType);
