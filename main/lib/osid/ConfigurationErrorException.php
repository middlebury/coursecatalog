...
/**
 * osid_ConfigurationErrorException
 * 
 *     Specifies the OSID exception osid_ConfigurationErrorException.
 * 
...
class osid_ConfigurationErrorException
    extends osid_OsidRuntimeException
{


    /**
     *  Constructs a <code>osid_ConfigurationErrorException</code> with the specified
