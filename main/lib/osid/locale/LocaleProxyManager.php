...
/**
 * osid_locale_LocaleProxyManager
 * 
 *     Specifies the OSID definition for osid_locale_LocaleProxyManager.
 * 
 ...
 *  this manager support the passing of an Authentication object for the 
 *  purposes of proxy authentication. The sessions included in this manager 
 *  are: </p> 
 *  
 *  <p> 
 *  <ul>
 ...
 * @package org.osid.locale
 */
interface osid_locale_LocaleProxyManager
            ...
            osid_locale_LocaleProfile
{
     ...
     */
    public function getLocaleSession(osid_authentication_Authentication $authentication);
     ...
     *  @return object osid_locale_LocaleSession a <code> LocaleSession 
     *          </code> 
     *  @throws osid_NullArgumentException <code> authentication, sourceType 
     *          </code> or <code> targetType </code> is <code> null </code> 
     *  @throws osid_OperationFailedException unable to complete request 
     *  @throws osid_PermissionDeniedException <code> authentication </code> 
     *          is invalid 
     ...
     *          </code> is <code> false or the authentication service isnot 
     *          supported </code> 
     *  @throws osid_IllegalStateException this manager has been shut down 
     *  @compliance optional This method must be implemented if <code> 
     ...
     */
    public function getLocaleAdminSession(osid_authentication_Authentication $authentication);
     ...
     */
    public function getUnitConversionSession(osid_authentication_Authentication $authentication);
     ...
     *              </code> 
     */
    public function getCurrencyConversionSession(osid_authentication_Authentication $authentication);
     ...
     *              </code> 
     */
    public function getCalendarConversionSession(osid_authentication_Authentication $authentication);
