...
/**
 * osid_NullArgumentException
 * 
 *     Specifies the OSID exception osid_NullArgumentException.
 * 
...
class osid_NullArgumentException
    extends osid_OsidRuntimeException
{


    /**
     *  Constructs a <code>osid_NullArgumentException</code> with the specified
