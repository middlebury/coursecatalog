...
/**
 * osid_authentication_AgentSearchResults
 * 
 *     Specifies the OSID definition for osid_authentication_AgentSearchResults.
 * 
 ...
 *  used as a vehicle to perform a aserach within a search. 
 *  <pre>
 *       
 *       
 ...
 * @package org.osid.authentication
 */
interface osid_authentication_AgentSearchResults
    extends osid_OsidSearchResults
{
     ...
     *
     *  @return object osid_authentication_AgentList the agent list 
     ...
     *          record type 
     *  @return object osid_authentication_AgentSearchResultsRecord the agent 
     *          search interface 
     ...
     *  @compliance mandatory This method must be implemented. 
     */
    public function getAgentSearchResultsRecord(osid_type_Type $agentSearchRecordType);
