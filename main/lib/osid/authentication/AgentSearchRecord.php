...
/**
 * osid_authentication_AgentSearchRecord
 * 
 *     Specifies the OSID definition for osid_authentication_AgentSearchRecord.
 * 
...
/**
 *  <p>A record for a <code> AgentSearch. </code> The methods specified by the 
 *  record type are available through the underlying object. </p>
 * 
 * @package org.osid.authentication
 */
interface osid_authentication_AgentSearchRecord
    extends osid_OsidSearchRecord
{


    /**
     *  Gets the <code> AgentSearch </code> from which this record originated. 
     *
