...
/**
 * osid_AlreadyExistsException
 * 
 *     Specifies the OSID exception osid_AlreadyExistsException.
 * 
...
class osid_AlreadyExistsException
    extends osid_OsidException
{


    /**
     *  Constructs a <code>osid_AlreadyExistsException</code> with the specified
