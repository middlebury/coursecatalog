...
/**
 * osid_repository_RepositoryHierarchySession
 * 
 *     Specifies the OSID definition for osid_repository_RepositoryHierarchySession.
 * 
 ...
 *  other OSIDs. Any <code> Repository </code> available in the Repository 
 ...
 * @package org.osid.repository
 */
interface osid_repository_RepositoryHierarchySession
    extends osid_hierarchy_HierarchyTraversalSession
{
    ...
    /**
     *  Gets the root repositories in the repository hierarchy. A node with no 
     *  parents is an orphan. While all repository <code> Ids </code> are 
     ...
     *
     *  @return object osid_repository_RepositoryList the root repositories 
     ...
     *
     *  @param object osid_id_Id $repositoryId the <code> Id </code> to query 
     *  @return object osid_repository_RepositoryList the parents of the 
     *          repository 
     ...
     */
    public function getParentRepositories(osid_id_Id $repositoryId);


    /**
     *  Gets the ancestors of the given repository. 
     *
     *  @param object osid_id_Id $repositoryId the <code> Id </code> to query 
     *  @param integer $levels the maximum number of levels to include. A 
     *          value of 1 returns the same set as <code> 
     *          getParentRepositories(). </code> 
     *  @return object osid_repository_RepositoryList the ancestors of the 
     *          repository 
     *  @throws osid_NotFoundException <code> repositoryId </code> not found 
     *  @throws osid_NullArgumentException <code> repositoryId </code> is 
     *          <code> null </code> 
     ...
     *  @compliance mandatory This method must be implemented. 
     */
    public function getAncestorRepositories(osid_id_Id $repositoryId, $levels);
     ...
     *
     *  @param object osid_id_Id $repositoryId the <code> Id </code> to query 
     *  @return object osid_repository_RepositoryList the children of the 
     *          repository 
     *  @throws osid_NotFoundException <code> repositoryId </code> not found 
     *  @throws osid_NullArgumentException <code> repositoryId </code> is 
     *          <code> null </code> 
     ...
     *  @compliance mandatory This method must be implemented. 
     */
    public function getChildRepositories(osid_id_Id $repositoryId);


    /**
     *  Gets the descendants of the given repository. 
     *
     *  @param object osid_id_Id $repositoryId the <code> Id </code> to query 
     *  @param integer $levels the maximum number of levels to include. A 
     *          value of 1 returns the same set as <code> 
     *          getChildRepositories(). </code> 
     *  @return object osid_repository_RepositoryList the descendants of the 
     *          repository 
     *  @throws osid_NotFoundException <code> repositoryId </code> not found 
     *  @throws osid_NullArgumentException <code> repositoryId </code> is 
     *          <code> null </code> 
     ...
     *  @compliance mandatory This method must be implemented. 
     */
    public function getDescendantRepositories(osid_id_Id $repositoryId, 
                                              $levels);
