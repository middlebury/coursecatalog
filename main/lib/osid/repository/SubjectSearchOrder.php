...
/**
 * osid_repository_SubjectSearchOrder
 * 
 *     Specifies the OSID definition for osid_repository_SubjectSearchOrder.
 * 
 ...
 * @package org.osid.repository
 */
interface osid_repository_SubjectSearchOrder
    extends osid_OsidSearchOrder
{
     ...
     *  subject record <code> Type. </code> Multiple retrievals return the 
     *  same underlying object. 
     *
     *  @param object osid_type_Type $subjectRecordType a subject record type 
     *  @return object osid_repository_SubjectSearchOrderRecord the subject 
     ...
     */
    public function getSubjectSearchOrderRecord(osid_type_Type $subjectRecordType);
