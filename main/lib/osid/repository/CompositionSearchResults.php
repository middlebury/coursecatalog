...
/**
 * osid_repository_CompositionSearchResults
 * 
 *     Specifies the OSID definition for osid_repository_CompositionSearchResults.
 * 
 ...
 * @package org.osid.repository
 */
interface osid_repository_CompositionSearchResults
    extends osid_OsidSearchResults
{
     ...
     *  @return object osid_repository_CompositionSearchResultsRecord the 
     *          composition search interface 
     ...
     *  @compliance mandatory This method must be implemented. 
     */
    public function getCompositionSearchResultsRecord(osid_type_Type $compositionSearchRecordType);
