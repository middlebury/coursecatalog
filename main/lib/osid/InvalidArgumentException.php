...
/**
 * osid_InvalidArgumentException
 * 
 *     Specifies the OSID exception osid_InvalidArgumentException.
 * 
...
class osid_InvalidArgumentException
    extends osid_OsidRuntimeException
{


    /**
     *  Constructs a <code>osid_InvalidArgumentException</code> with the specified
