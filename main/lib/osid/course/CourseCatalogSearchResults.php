...
/**
 * osid_course_CourseCatalogSearchResults
 * 
 *     Specifies the OSID definition for osid_course_CourseCatalogSearchResults.
 * 
 ...
 * @package org.osid.course
 */
interface osid_course_CourseCatalogSearchResults
    extends osid_OsidSearchResults
{
     ...
     *
     *  @return object osid_course_CourseCatalogList the course catalog list 
     ...
     *  @return object osid_course_CourseCatalogSearchResultsRecord the course 
     ...
     *  @compliance mandatory This method must be implemented. 
     */
    public function getCourseCatalogSearchResultsRecord(osid_type_Type $courseCatalogSearchRecordType);
