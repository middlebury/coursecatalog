...
/**
 * osid_course_TopicForm
 * 
 *     Specifies the OSID definition for osid_course_TopicForm.
 * 
...
/**
 *  <p>This is the form for creating and updating <code> Topics. </code> Like 
 *  all <code> OsidForm </code> objects, various data elements may be set here 
 *  for use in the create and update methods in the <code> TopicAdminSession. 
 *  </code> For each data element that may be set, metadata may be examined to 
 *  provide display hints or data constraints. </p>
 * 
 * @package org.osid.course
 */
interface osid_course_TopicForm
    extends osid_OsidForm
{


    /**
     *  Gets the <code> TopicFormRecord </code> interface corresponding to the 
     *  given topic record interface <code> Type. </code> 
     *
     *  @param object osid_type_Type $topicRecordType a topic record type 
     *  @return object osid_course_TopicFormRecord the record 
     ...
     */
    public function getTopicFormRecord(osid_type_Type $topicRecordType);
