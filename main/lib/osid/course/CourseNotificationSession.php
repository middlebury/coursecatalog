...
/**
 * osid_course_CourseNotificationSession
 * 
 *     Specifies the OSID definition for osid_course_CourseNotificationSession.
 * 
 ...
 *  to <code> Course </code> objects in this <code> CourseCatalog. </code> 
 *  This also includes existing courses that may appear or disappear due to 
 *  changes in the <code> CourseCatalog </code> hierarchy, This session is 
 ...
 *  <code> CourseLookupSession. </code> </p>
 * 
 * @package org.osid.course
 */
interface osid_course_CourseNotificationSession
    extends osid_OsidSession
{
    ...
    /**
     *  Tests if this user can register for <code> Course </code> 
     ...
     *  @compliance mandatory This method must be implemented. 
     */
    public function canRegisterForCourseNotifications();
    ...
    /**
     *  Register for notifications of new courses. <code> 
     *  CourseReceiver.newCourse() </code> is invoked when a new <code> Course 
     ...
     *  @compliance mandatory This method must be implemented. 
     */
    public function registerForNewCourses();


    /**
     *  Registers for notification of updated courses. <code> 
     *  CourseReceiver.changedCourse() </code> is invoked when a course in 
     ...
     *  @compliance mandatory This method must be implemented. 
     */
    public function registerForChangedCourses();


    /**
     *  Registers for notification of an updated course. <code> 
     *  CourseReceiver.changedCourse() </code> is invoked when the specified 
     *  course in this course catalog is changed. 
     *
     *  @param object osid_id_Id $courseId the <code> Id </code> of the <code> 
     *          Course </code> to monitor 
     *  @throws osid_NotFoundException a course was not found in this course 
     ...
     *  @compliance mandatory This method must be implemented. 
     */
    public function registerForChangedCourse(osid_id_Id $courseId);


    /**
     *  Registers for notification of deleted courses. <code> 
     *  CourseReceiver.deletedCourse() </code> is invoked when a course is 
     ...
     *  @compliance mandatory This method must be implemented. 
     */
    public function registerForDeletedCourses();


    /**
     *  Registers for notification of a deleted course. <code> 
     *  CourseReceiver.deletedCourse() </code> is invoked when the specified 
     *  course is deleted or removed from this course catalog. 
     *
     *  @param object osid_id_Id $courseId the <code> Id </code> of the <code> 
     *          Course </code> to monitor 
     *  @throws osid_NotFoundException a course was not found identified by 
     ...
     *  @compliance mandatory This method must be implemented. 
     */
    public function registerForDeletedCourse(osid_id_Id $courseId);
