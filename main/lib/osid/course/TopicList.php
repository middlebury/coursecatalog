...
/**
 * osid_course_TopicList
 * 
 *     Specifies the OSID definition for osid_course_TopicList.
 * 
...
/**
 *  <p>Like all <code> OsidLists, </code> <code> TopicList </code> provides a 
 *  means for accessing <code> Topic </code> elements sequentially either one 
 ...
 *       
 *       while (tl.hasNext()) {
 *            Topic[] topic = tl.getNextTopics(tl.available());
 *       }
 *       
 *                   
 *       
 ...
 * @package org.osid.course
 */
interface osid_course_TopicList
