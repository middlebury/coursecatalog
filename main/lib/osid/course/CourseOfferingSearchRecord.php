...
/**
 * osid_course_CourseOfferingSearchRecord
 * 
 *     Specifies the OSID definition for osid_course_CourseOfferingSearchRecord.
 * 
...
/**
 *  <p>A record for a <code> CourseOfferingSearch. </code> The methods 
 *  specified by the record type are available through the underlying object. 
 *  </p>
 * 
 * @package org.osid.course
 */
interface osid_course_CourseOfferingSearchRecord
    extends osid_OsidSearchRecord
{


    /**
     *  Gets the <code> CourseOfferingSearch </code> from which this record 
     *  originated. 
     *
