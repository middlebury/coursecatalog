...
/**
 * osid_NoAccessException
 * 
 *     Specifies the OSID exception osid_NoAccessException.
 * 
...
class osid_NoAccessException
    extends osid_OsidRuntimeException
{


    /**
     *  Constructs a <code>osid_NoAccessException</code> with the specified
