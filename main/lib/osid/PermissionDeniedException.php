...
/**
 * osid_PermissionDeniedException
 * 
 *     Specifies the OSID exception osid_PermissionDeniedException.
 * 
...
class osid_PermissionDeniedException
    extends osid_OsidException
{


    /**
     *  Constructs a <code>osid_PermissionDeniedException</code> with the specified
