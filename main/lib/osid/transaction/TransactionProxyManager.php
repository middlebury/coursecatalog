...
/**
 * osid_transaction_TransactionProxyManager
 * 
 *     Specifies the OSID definition for osid_transaction_TransactionProxyManager.
 * 
 ...
 * @package org.osid.transaction
 */
interface osid_transaction_TransactionProxyManager
            ...
            osid_transaction_TransactionProfile
{
     ...
     *  @throws osid_UnsupportedException a <code> uthentication </code> is 
     *          not supported 
     *  @throws osid_IllegalStateException this manager has been shut down 
     *  @compliance mandatory This method must be implemented. 
     */
    public function getTransactionSession(osid_authentication_Authentication $authentication);
