 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU General Public License (GPL)
 */
class banner_course_AllCourseOfferingsList
	...
	implements osid_course_CourseOfferingList
{
	 ...
	 * @since 4/13/09
	 */
	public function __construct (PDO $db, $catalogDatabaseId, banner_course_CourseOfferingSessionInterface $session, $idAuthority, $idPrefix) {
