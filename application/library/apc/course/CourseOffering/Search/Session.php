 ...
 */
class apc_course_CourseOffering_Search_Session extends apc_course_CachableSession implements osid_course_CourseOfferingSearchSession
{
    /**
     * Constructor.
     *
    ...
    public function getCourseOfferingsByQuery(osid_course_CourseOfferingQuery $courseQuery)
    {
        ...
        return new apc_course_CourseOffering_List(
    ...
    {
        // Wrap course objects as APCu versions
        return new apc_course_CourseOffering_Search_Results(
            $this->manager->getCourseOfferingLookupSessionForCatalog($this->getCourseCatalogId()),
