 ...
 */
class apc_course_Course_Search_Session extends apc_course_CachableSession implements osid_course_CourseSearchSession
{
    ...
    public function getCoursesByQuery(osid_course_CourseQuery $courseQuery)
    {
        ...
        return new apc_course_Course_List(
    ...
    {
        // Wrap course objects as APCu versions
        return new apc_course_Course_Search_Results(
            $this->manager->getCourseLookupSessionForCatalog($this->getCourseCatalogId()),
