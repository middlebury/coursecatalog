 ...
 */
class apc_course_Course_Search_Results implements osid_course_CourseSearchResults
{
    ...
    {
        return new apc_course_Course_List($this->apcSession, $this->results->getCourses());
    }
