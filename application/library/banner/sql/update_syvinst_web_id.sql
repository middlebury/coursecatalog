...
ALTER TABLE `SYVINST` CHANGE `WEB_ID` `WEB_ID` VARCHAR(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT 'This field is used in web applications to identify individuals rather than using their PIDMs.';
