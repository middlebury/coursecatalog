...
class banner_resource_test_TestSuite extends PHPUnit_Framework_TestSuite
{
    ...
    {
    	$this->courseDir = dirname(__FILE__).'/../../course';
    	$this->sharedFixture = array();
    	$this->sharedFixture['RuntimeManager'] = new phpkit_AutoloadOsidRuntimeManager($this->courseDir.'/test/configuration.plist');
...
//     	$this->sharedFixture['RuntimeManager']->shutdown();
        ...
        harmoni_SQLUtils::runSQLfile($this->courseDir.'/sql/drop_tables.sql', $db);
