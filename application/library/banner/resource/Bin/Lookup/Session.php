 ...
 */
class banner_resource_Bin_Lookup_Session
	extends banner_AbstractSession
	implements osid_resource_BinLookupSession
{
...
");
		...
		self::$getBinById_stmt->execute(array(':catalog_id' => $this->getDatabaseIdString($binId)));
	...
	public function getBinsByGenusType(osid_type_Type $binGenusType) {
		if ($binGenusType->isEqual(new phpkit_type_URNInetType("urn:inet:osid.org:genera:none")))
			...
			return new phpkit_resource_ArrayBinList(array());
	}
