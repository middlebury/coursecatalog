 ...
 */
class banner_course_Course_Search_Order
	extends banner_course_AbstractSearchOrder
    implements osid_course_CourseSearchOrder
{
 ...
 *********************************************************/
    ...
    public function orderByTitle() {
    	$this->addOrderColumns(array('SCBCRSE_TITLE'));
    }
    ...
    public function orderByNumber() {
    	$this->addOrderColumns(array('SCBCRSE_SUBJ_CODE', 'SCBCRSE_CRSE_NUMB'));
    }
    ...
    public function orderByCredits() {
    	$this->addOrderColumns(array('SCBCRSE_CREDIT_HR_HIGH'));
    }
