...
FROM 
	catalog_term
	LEFT JOIN ssbsect_scbcrse ON term_code = SSBSECT_TERM_CODE
	...
	LEFT JOIN SCBDESC ON (SSBSECT_SUBJ_CODE = SCBDESC_SUBJ_CODE AND SSBSECT_CRSE_NUMB = SCBDESC_CRSE_NUMB AND SSBSECT_TERM_CODE >= SCBDESC_TERM_CODE_EFF AND (SCBDESC_TERM_CODE_END IS NULL OR SSBSECT_TERM_CODE <= SCBDESC_TERM_CODE_END))
WHERE
