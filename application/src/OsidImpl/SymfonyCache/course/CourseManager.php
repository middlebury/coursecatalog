...
namespace Catalog\OsidImpl\SymfonyCache\course;

use Catalog\OsidImpl\SymfonyCache\course\Course\CourseLookupSession;
use Catalog\OsidImpl\SymfonyCache\course\Course\CourseSearchSession;
 ...
 * access to course information provided by another OSID implementation.
 *
 * @copyright Copyright &copy; 2025, Middlebury College
 * @license http://www.gnu.org/copyleft/gpl.html GNU General Public License (GPL)
 */
class CourseManager extends \phpkit_AbstractOsidManager implements \osid_course_CourseManager
{
    ...
    public function initialize(\osid_OsidRuntimeManager $runtime)
    {
        ...
        try {
            $implClassName = \phpkit_configuration_ConfigUtil::getSingleValuedValue(
                ...
                new \phpkit_id_URNInetId('urn:inet:middlebury.edu:config:symfonycache_course.impl_class_name'),
    ...
    {
        return new CourseLookupSession($this, $this->manager->getCourseLookupSession());
    }
    ...
    {
        return new CourseLookupSession($this, $this->manager->getCourseLookupSessionForCatalog($courseCatalogId), $courseCatalogId);
    }
    ...
    {
        return new CourseSearchSession($this, $this->manager->getCourseSearchSession());
    }
    ...
    {
        return new CourseSearchSession($this, $this->manager->getCourseSearchSessionForCatalog($courseCatalogId));
    }
    ...
    {
        return new CourseOfferingLookupSession($this, $this->manager->getCourseOfferingLookupSession());
    }
    ...
    {
        return new CourseOfferingLookupSession($this, $this->manager->getCourseOfferingLookupSessionForCatalog($courseCatalogId), $courseCatalogId);
    }
    ...
    {
        return new CourseOfferingSearchSession($this, $this->manager->getCourseOfferingSearchSession());
    }
    ...
    {
        return new CourseOfferingSearchSession($this, $this->manager->getCourseOfferingSearchSessionForCatalog($courseCatalogId));
    }
    ...
    {
        return new TopicLookupSession($this, $this->manager->getTopicLookupSession());
    }
    ...
    {
        return new TopicLookupSession($this, $this->manager->getTopicLookupSessionForCatalog($courseCatalogId));
    }
