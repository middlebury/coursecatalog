 ...
 */
class CourseOfferingSearchResults implements \osid_course_CourseOfferingSearchResults
{
    ...
    {
        return new CourseOfferingList($this->cacheSession, $this->results->getCourseOfferings());
    }
